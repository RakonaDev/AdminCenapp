...
import { getOriginalFilename } from '../../../shared/funtions'
        ...
        <div className="p-4 rounded-xl mt-0">
          <div className="w-full flex justify-end">
            <button
              ...
              onClick={() => {
                navigate('/admin/banners/agregar')
              }}
            >
              Agregar banner
            </button>
              ...
              >
                <div className="flex items-center justify-center absolute top-0 left-0 w-full h-full bg-black/50 z-[-300] opacity-0 group-hover:z-[300] group-hover:opacity-100 transition-all ">
                  <div className="flex gap-4">
                    <Link className="text-xl hover:text-green-500 transition-colors" to={`/admin/banners/editar/${pro.id}`}>
                      <svg
                        stroke="currentColor"
                        fill="currentColor"
                        strokeWidth="0"
